...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference("Agenda.count") do
      post agendas_url, params: { agenda: { data_hora: @agenda.data_hora, estado: @agenda.estado, paciente_id: @agenda.paciente_id, valor: @agenda.valor } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { data_hora: @agenda.data_hora, estado: @agenda.estado, paciente_id: @agenda.paciente_id, valor: @agenda.valor } }
